"""
Module 02 - Lesson 02: Tool-Calling Autonomous Agent
Demonstrates binding Python tools to LLM and building a tool execution loop using ToolNode and tools_condition.
"""
